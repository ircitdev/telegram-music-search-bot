...
- 🎬 **Видео-ссылки** - кнопка для просмотра YouTube видео после скачивания (NEW!)
...
- 📈 **Статистика пользователя** - топ артистов, время прослушивания, счётчики (NEW!)
...
- [x] **Видео-ссылки** - кнопка для просмотра YouTube (22.02.2026)
- [x] **Статистика юзера** - /my_stats команда (22.02.2026)

### 🔄 В планах (приоритет 1)

- [ ] Управление плейлистами (создание, шаринг)
- [ ] Фильтры поиска (по длительности, типу)
- [ ] Батч-скачивание (несколько треков сразу)
- [ ] Рекомендации по настроению (Chill/Party/Workout)

### 📋 Долгосрочные планы

- [ ] Redis для кэширования
- [ ] Telegram WebApp интерфейс
- [ ] Интеграция Spotify/Apple Music
- [ ] ML-рекомендации
- [ ] PostgreSQL миграция
